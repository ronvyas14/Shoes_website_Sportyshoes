package com.api.Shoeswebsite.service.impl;
...
import com.api.Shoeswebsite.exceptionHandler.BusinessException;
import com.api.Shoeswebsite.model.PurchaseReport;
import com.api.Shoeswebsite.model.Shoe;
import com.api.Shoeswebsite.repository.PurchaseReportRepository;
import com.api.Shoeswebsite.repository.ShoesRepository;
import com.api.Shoeswebsite.service.SportyShoesService;
...
public class SportyShoesServiceImpl implements SportyShoesService{
	...
	@PostConstruct
	public void init() {
		Shoe s1 = new Shoe(1,"Shoe Name 1","Volleyball",1000.24);
		Shoe s2 = new Shoe(2,"Shoe Name 2","Cricket",1100.24);
		Shoe s3 = new Shoe(3,"Shoe Name 3","Running",900.24);
		Shoe s4 = new Shoe(4,"Shoe Name 4","tennis",1900.24);
